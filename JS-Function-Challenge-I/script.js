...
/* Challenge 1
    DOCU: This function calculates the sum of all numbers in an array.  
    Function name- calculateSum
    @param {number[]} arr - An array of numbers to be summed.  
    @returns {number} - The total sum of all elements in the array.  
    @throws {Error} - No errors are expected in normal operation.  
*/
function calculateSum(arr) {
  ...
  let numbers = [1, 2, 3, 4];
  console.log("Sum:", calculateSum(numbers));   // predicted result: 10
